...
export const BADGE_REGISTRY: BadgeDefinition[] = [
  ...
  { id: "century_rescuer",        title: "Century Rescuer",        description: "An incredible 100 meals rescued",           icon: FaTrophy,        color: "emerald",  category: "meals_rescued", rarity: "epic",      threshold: 100,  thresholdUnit: "meals rescued", imageUrl: "/badges/century_rescuer.png" },
  { id: "planet_protector",       title: "Planet Protector",       description: "250 meals rescued — protecting the planet",  icon: FaGlobe,         color: "emerald",  category: "meals_rescued", rarity: "epic",      threshold: 250,  thresholdUnit: "meals rescued", imageUrl: "/badges/planet_protector.png" },
  { id: "sustainability_legend",  title: "Sustainability Legend",  description: "500 meals rescued — a living legend",        icon: FaCrown,         color: "emerald",  category: "meals_rescued", rarity: "legendary", threshold: 500,  thresholdUnit: "meals rescued", imageUrl: "/badges/sustainability_legend.png" },
  { id: "global_guardian",        title: "Global Guardian",        description: "1000 meals — guardian of the planet",        icon: FaGem,           color: "emerald",  category: "meals_rescued", rarity: "legendary", threshold: 1000, thresholdUnit: "meals rescued", imageUrl: "/badges/global_guardian.png" },

  // ── Meals Shared ──
  { id: "first_donation",         title: "First Donation",         description: "Shared your very first meal",               icon: FaSeedling,      color: "blue",     category: "meals_shared",  rarity: "common",    threshold: 1,    thresholdUnit: "meals shared", imageUrl: "/badges/first_donation.png" },
